...
// and a packet is the only source of species you have never grown.
import { useState } from 'react'
import type { Gardener } from '../types'
import { SHOP_ITEMS, currentMultiplier, isGnomeWorking, type ShopKind } from '../game/shop'
                ...
                return (
                  <div key={item.id} className="shed-row">
                    <div className="shed-item">
                      ...
                      <span className="tiny muted">{item.blurb}</span>
                    </div>
